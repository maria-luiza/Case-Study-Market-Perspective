...
png(filename = "value_month_year.png", width = 825, height = 660, units = "px")
...
png(filename = "sales_executive_years.png", width = 770, height = 665, units = "px")
...
# 4.4 Summary Boxplot
png(filename = "summary_years.png", width = 825, height = 660, units = "px")
# Get only information used to evaluate
box_data <- select(data, Year, Value, Lost_Deal)
plot_boxplot_summary(box_data)
dev.off()
